...
public class PlayerData {
	...
	public enum TrailEffect {
		...
		ANGRY_VILLAGER("Angry Villager", Particle.ANGRY_VILLAGER, Material.VILLAGER_SPAWN_EGG, 12),
		ENCHANT("Enchant", Particle.ENCHANT, Material.ENCHANTING_TABLE, 15, 7),
		SPLASHING("Splashing", Particle.SPLASH, Material.WATER_BUCKET, 20, 3),
